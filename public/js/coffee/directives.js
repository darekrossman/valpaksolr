...
(function() {
  ...
  module.directive('couponSearch', [
    'ListingFilter', '$location', '$rootScope', 'User', function(ListingFilter, $location, $rootScope, User) {
      return {
        scope: true,
        ...
        link: function(scope, element, attrs) {
          ...
          scope.performSearch = function() {
            ...
            return $location.url("/coupons/query?keywords=" + ListingFilter.searchTerms + "&geo=" + User.geo);
          };
